 ...
 * on multiple cells forming a tetromino shape. The tetromino is formed by randomly by picking a direction
 * from the current cell and placing the next cell there. If a tank fails to be generated after a certain
 * amount of attempts, the cells of the partial tank will be reset into empty cells and the board will pick another
