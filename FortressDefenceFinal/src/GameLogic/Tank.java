...
/**
 * Tank class stores information of a tank game object. Each tank is composed of cells, which together
 * form a tank and has a certain amount of damage. The damage of a tank depends on the amount of cells
 * remaining. When the tank contains no more cells, the tank will not be able to produce any more damage.
 */
